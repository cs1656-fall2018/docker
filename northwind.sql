...
CREATE TABLE IF NOT EXISTS `customers` (
  `CustomerID` int(2) NOT NULL DEFAULT '0',
  `CustomerName` varchar(64) DEFAULT NULL,
  `ContactName` varchar(512) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  UNIQUE KEY `LastName` (`LastName`,`FirstName`,`BirthDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(5, 'Buchanan', 'Steven', '4/03/1955', 'EmpID5.pic', 'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London, where he was promoted to sales manager. Mr. Buchanan has completed the courses ''Successful Telemarketing'' and ''International Sales Management''. He is fluent in French.'),
(6, 'Suyama', 'Michael', '2/07/1963', 'EmpID6.pic', 'Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses ''Multi-Cultural Selling'' and ''Time Management for the Sales Professional''. He is fluent in Japanese and can read and write French, Portuguese, and Spanish.'),
...
(8, 'Callahan', 'Laura', '9/01/1958', 'EmpID8.pic', 'Laura received a BA in psychology from the University of Washington. She has also completed a course in business French. She reads and writes French.'),
(9, 'Dodsworth', 'Anne', '2/07/1969', 'EmpID9.pic', 'Anne has a BA degree in English from St. Lawrence College. She is fluent in French and German.'),
(10, 'West', 'Adam', '19/09/1928', 'EmpID10.pic', 'An old chum.');

CREATE TABLE IF NOT EXISTS `orderdetails` (
  `OrderDetailID` int(3) NOT NULL DEFAULT '0',
...
(10270, 87, 1, '1/08/1996', 1),
(10271, 75, 6, '1/08/1996', 2),
(10272, 65, 6, '2/08/1996', 2),
(10273, 63, 3, '5/08/1996', 3),
(10274, 85, 6, '6/08/1996', 1),
(10275, 49, 1, '7/08/1996', 1),
(10276, 80, 8, '8/08/1996', 3),
(10277, 52, 2, '9/08/1996', 3),
...
(10295, 85, 2, '2/09/1996', 2),
(10296, 46, 6, '3/09/1996', 1),
(10297, 7, 5, '4/09/1996', 2),
(10298, 37, 6, '5/09/1996', 2),
(10299, 67, 4, '6/09/1996', 2),
(10300, 49, 2, '9/09/1996', 2),
(10301, 86, 8, '9/09/1996', 2),
...
(10400, 19, 1, '1/01/1997', 3),
(10401, 65, 1, '1/01/1997', 1),
(10402, 20, 8, '2/01/1997', 2),
(10403, 20, 4, '3/01/1997', 3),
(10404, 49, 2, '3/01/1997', 1),
(10405, 47, 1, '6/01/1997', 1),
(10406, 62, 7, '7/01/1997', 1),
(10407, 56, 2, '7/01/1997', 2),
(10408, 23, 8, '8/01/1997', 1),
(10409, 54, 3, '9/01/1997', 1),
...
(10433, 60, 3, '3/02/1997', 3),
(10434, 24, 3, '3/02/1997', 2),
(10435, 16, 8, '4/02/1997', 2),
(10436, 7, 3, '5/02/1997', 2),
(10437, 87, 8, '5/02/1997', 1),
(10438, 79, 3, '6/02/1997', 2),
(10439, 51, 6, '7/02/1997', 3),
...
CREATE TABLE IF NOT EXISTS `shippers` (
  `ShipperID` int(1) NOT NULL DEFAULT '0',
  `ShipperName` varchar(16) DEFAULT NULL,
  `Phone` varchar(14) DEFAULT NULL,
  PRIMARY KEY (`ShipperID`),
  UNIQUE KEY `ShipperName` (`ShipperName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `suppliers` (
  `SupplierID` int(2) NOT NULL DEFAULT '0',
